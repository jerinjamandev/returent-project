    ...
    <section className="bg-neutral-50 py-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col lg:flex-row items-center lg:items-start gap-12">
                    <div className="relative w-full lg:w-1/2 mb-12 lg:mb-0 order-2 lg:order-1"> {/* order-2/1 to ensure image/contact is first visually on mobile */}
          ...
          <div className="w-full lg:w-1/2 lg:pl-16 mt-16 lg:mt-0 pt-10 lg:pt-0 order-1 lg:order-2"> {/* order-1/2 to ensure text is first visually on mobile */}
